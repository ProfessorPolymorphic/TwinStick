...
for(i in seq_along(Genes)){
  ...
  plot <- ggplot(data = GeneAvg, aes(x = as.numeric(Generation), y = !!sym(paste("var.",Genes[i], sep = ""))))+
    geom_point()+
    geom_smooth(data = GeneAvg, aes(x = as.numeric(Generation), y = !!sym(paste("var.",Genes[i], sep = "")), method = "loess")) +
    theme(legend.position = "none") +
    facet_wrap(~file, ncol = 2) 
